const STATIC_CACHE_VERSION = 'v13'; // ← Increment this when you update assets
const DYNAMIC_CACHE_VERSION = 'dynamic-v13'; // ← Increment this too
...
const assets = [
    ...
    "/assets/images/logos/Project.webp",
    "/manifest.json"
];
